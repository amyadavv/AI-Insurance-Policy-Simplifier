      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {features.map((feature, index) => (
            ...
            >
              <div
                className="smooth-card rounded-2xl p-8 border hover:shadow-lg transition-all flex flex-col justify-between w-full"
              ...
              >
                <div>
                  ...
                  <p className="text-base leading-relaxed text-muted-theme">{feature.description}</p>
                </div>
              </div>
            </ScrollReveal>
          ))}
