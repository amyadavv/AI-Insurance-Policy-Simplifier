      ...
      <div className="max-w-5xl mx-auto">
        <ScrollReveal animation="fade-up">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-theme mt-2 text-base">
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 text-left text-base font-bold text-primary-theme focus:outline-none"
                >
                  <span>{faq.q}</span>
                  <HiChevronDown
                ...
                {activeFaq === idx && (
                  <div className="px-5 pb-5 pt-1 text-sm text-muted-theme leading-relaxed border-t" style={{ borderColor: 'var(--border)' }}>
                    {faq.a}
                  </div>
                )}
              </div>
