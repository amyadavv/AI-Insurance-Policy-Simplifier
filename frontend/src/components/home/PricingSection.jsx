      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
          {pricingPlans.map((plan, index) => (
            ...
            >
              <div
                className={`smooth-card rounded-2xl p-8 border flex flex-col justify-between relative w-full ${
              ...
              >
                {plan.isPopular && (
                  <span className="absolute top-0 right-6 -translate-y-1/2 bg-primary-600 text-white text-[10px] uppercase font-extrabold px-3 py-1 rounded-full tracking-wider z-10">
                    Most Popular
                  </span>
                )}
                ...
                <div>
                  ...
                  <p className="text-sm text-subtle-theme mt-1">{plan.desc}</p>
                  ...
                  <div className="my-6 flex items-baseline space-x-1">
                    ...
                    <span className="text-sm text-muted-theme">/ {plan.period}</span>
                  </div>

                  <ul className="space-y-3.5 mb-8">
                    {plan.features.map((feature, fIdx) => (
                      <li key={fIdx} className="flex items-start space-x-2.5 text-sm text-muted-theme">
                ...
                <Link
                  to={plan.buttonLink}
                  className={`smooth-btn w-full text-center py-3 rounded-xl text-sm font-bold ${
                    plan.isPopular
